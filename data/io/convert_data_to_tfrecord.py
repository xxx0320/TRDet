...
tf.app.flags.DEFINE_string('VOC_dir', '/Data/pbc/data/house_aug_xml/train/', 'Voc dir')
...
tf.app.flags.DEFINE_string('dataset', 'pbcdata', 'dataset')
...
def convert_pascal_to_tfrecord():
    ...
    save_path = FLAGS.save_dir + FLAGS.dataset + '_ha' + FLAGS.save_name + '.tfrecord'
