...
# VERSION = 'R2CNN_210327_pbcdata_v0'
VERSION = 'R2CNN_211002_pbcdata'
NET_NAME = 'resnet_v1_101'
ADD_BOX_IN_TENSORBOARD = True
# ---------------------------------------- System_config
ROOT_PATH = os.path.abspath('/Data/pbc/R2CNN-Plus-Plus_h/')
print(20*"++--")
print(ROOT_PATH)
GPU_GROUP = "2"
...
TEST_SAVE_PATH = ROOT_PATH + '/tools/test_result/test_Z'
...
PRETRAINED_CKPT = '/Data/pbc/R2CNN-Plus-Plus/data/pretrained_weights/' + weights_name + '.ckpt'
...
MAX_ITERATION = 300000   # 300000 Not pyramid images training

# -------------------------------------------- Data_preprocess_config
DATASET_NAME = 'pbcdata'  # 'ship', 'spacenet', 'pascal', 'coco'
PIXEL_MEAN = [123.68, 116.779, 103.939]  # R, G, B. In tf, channel is RGB. In openCV, channel is BGR
IMG_SHORT_SIDE_LEN = [800, 1000]
IMG_MAX_LENGTH = 1000
CLASS_NUM = 1
...
# ANCHOR_RATIOS = [1, 7 / 5., 5 / 7., 1 / 2., 2., 4., 1 / 4.]
# ANCHOR_RATIOS = [1, 7 / 5., 5 / 7., 1 / 2., 2., 4., 1 / 4., 9., 1 / 9.]
# ANCHOR_RATIOS = [1, 1 / 2, 2., 1 / 3., 3., 5., 1 / 4., 4., 1 / 5., 6., 1 / 6., 7., 1 / 7., 9., 1 / 9., 5 / 7., 7 / 5.]
